...
import { Download, Share2, Twitter, Instagram, X, Loader2 } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogTrigger,
...
export function ShareModal({ message, username, trigger }: ShareModalProps) {
  ...
  const handleShare = async () => {
    ...
    try {
      ...
      const file = new File([blob], `vox-message-${Date.now()}.png`, {
        type: "image/png",
      });
      ...
      <DialogContent className="bg-zinc-950 border-zinc-800 text-white w-[95vw] max-w-sm p-0 overflow-hidden flex flex-col max-h-[90vh]">
              ...
              <div className="relative z-10 p-6 flex flex-col h-full justify-between backdrop-blur-[1px]">
                <div className="flex items-center gap-2 mb-4 opacity-80">
                  <div
                    ...
                    style={{
                      backgroundColor: selectedTheme.bubble,
                      color: "#000000",
                ...
                <div className="flex-1 flex flex-col justify-center min-h-0">
                  <div
                    className="p-5 rounded-2xl shadow-lg mb-4"
                    style={{
                  ...
                  >
                    <p
                      className="font-medium text-lg leading-relaxed font-sans break-words whitespace-pre-wrap"
                      style={{
                        color: "#ffffff",
                  ...
                  {reply && (
                    <div className="self-end max-w-[85%]">
                      <div
                        className="p-4 rounded-2xl rounded-tr-sm shadow-lg"
                        style={{
                          backgroundColor: selectedTheme.bubble,
                          color: "#000000",
                        }}
                      >
                        <p
                          className="font-bold text-sm leading-snug break-words whitespace-pre-wrap"
                          style={{
                            overflowWrap: "break-word",
                            wordBreak: "break-word",
                          }}
        ...
        <div className="p-4 bg-zinc-900 border-t border-zinc-800 flex gap-2">
          ...
          <Button
            ...
            variant="outline"
            className="bg-black border-zinc-700 text-zinc-300 hover:text-white hover:bg-zinc-800"
          >
            {isDownloading ? (
