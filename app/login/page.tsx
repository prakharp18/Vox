        ...
        <main className="min-h-screen w-full bg-[#121212] flex items-center justify-center p-4 md:p-8">
            ...
            >
                ...
                <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white relative z-20">
                    ...
                    <p className="text-zinc-500 text-center mb-10">Please enter your details to log in.</p>
                    ...
                    <p className="mt-10 text-center text-sm text-zinc-500">
                        <Link href="/signup" className="text-zinc-900 font-medium hover:underline">Create an account</Link>
                    </p>
                </div>
            </motion.div>
        </main>
